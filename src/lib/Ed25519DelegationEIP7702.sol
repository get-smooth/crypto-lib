...
contract Ed25519Delegation {
    ...
    function authorize(
        address DeployedEdSigner,
        uint256 publicKeyX,
        uint256 publicKeyY,
        uint256 publicKeyX128,
        uint256 publicKeyY128,
        uint256 publicKeyCompressed
    ) public {
    ...
    function transact(address to, bytes memory data, uint256 value, bytes32 r, bytes32 s) public {
        ...
        require(
            Ed25519.Verify_LE(
                ...
                uint256(s),
                [
                    authorizedPublicKeyX,
                    authorizedPublicKeyY,
                    authorizedPublicKeyX128,
                    authorizedPublicKeyY128,
                    authorizedPublicKeyCompressed
                ]
            ),
            "Invalid signature"
        );
