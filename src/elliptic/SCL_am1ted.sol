...
import { MINUS_1, p, d, a, gx, gy, n, pMINUS_2, nMINUS_2, deux_d, scaling_factor, unscaling_factor } from "@solidity/include/SCL_field.h.sol"; 
import { pModInv } from "@solidity/modular/SCL_modular.sol"; 
  ...
  function ed_AddAff(uint256 x1, uint256 y1, uint256 x2, uint256 y2) view returns (uint256 x3, uint256 y3) {
        uint256 z3;
        uint256 t3;
        (x3, y3, z3, t3) = ec_Add(x1, y1, 1, mulmod(x1, y1, p), x2, y2, 1, mulmod(x2, y2, p));
        return ec_Normalize(x3, y3, z3,t3);
    }
