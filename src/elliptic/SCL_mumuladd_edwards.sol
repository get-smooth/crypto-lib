...
import{deux_d, gx, gy, p, pMINUS_2, MINUS_1, n} from "@solidity/include/SCL_field.h.sol"; 
import { pModInv } from "@solidity/modular/SCL_modular.sol"; 

    function ed_z2Aff(uint256 x, uint256 y, uint256 z)  returns (uint256 x1, uint256 y1) {
        // 1/zzz
    ...
    function ed_AddAff(uint256 x1, uint256 y1, uint256 x2, uint256 y2)  returns (uint256 x3, uint256 y3) {
        uint256 z3;
        uint256 t3;
